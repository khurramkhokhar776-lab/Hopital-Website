...
app.post("/appointment", async (req, res) => {
  ...
  try {
    ...
    // Email temporarily skipped because Gmail SMTP is timing out on Render
    console.log("📧 Email skipped temporarily to avoid SMTP timeout");
...
// force redeploy after email skip fix
